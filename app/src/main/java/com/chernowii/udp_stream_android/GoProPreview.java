...
public class GoProPreview extends AppCompatActivity implements IVLCVout.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setHQ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog = new Dialog(GoProPreview.this);
                ...
                for(int i=0;i<stringList.size();i++){
                    RadioButton rb=new RadioButton(GoProPreview.this); // dynamically creating RadioButton and adding to RadioGroup.
    ...
    private static class MyPlayerListener implements MediaPlayer.EventListener {
        private WeakReference<GoProPreview> mOwner;

        public MyPlayerListener(GoProPreview owner) {
            mOwner = new WeakReference<GoProPreview>(owner);
        }

        @Override
        public void onEvent(MediaPlayer.Event event) {
            GoProPreview player = mOwner.get();
